...
const AnimatedButton = ({ 
  ...
  const effectiveBorderColor = borderColor === 'transparent' && !isDark ? '#b5b5b5' : borderColor;
  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: !isDark && !isHovered ? '0 1px 3px rgba(0, 0, 0, 0.05)' : undefined,
        transition: isEnding ? 'box-shadow 0.5s ease' : 'background-color 0.3s, color 0.3s, border-color 0.3s',
    ...
    >
      <span
        ...
        style={{
          ...
          background: 'radial-gradient(ellipse at center, rgba(255, 255, 255, 0.35) 0%, rgba(255, 255, 255, 0.15) 40%, rgba(255, 255, 255, 0.05) 60%, rgba(255, 255, 255, 0) 70%)',
          filter: 'blur(5px)',
          borderRadius: '50%',
        }}
      />
