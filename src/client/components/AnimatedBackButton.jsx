...
const AnimatedBackButton = ({ to = "/", text = "Go back", icon = <FaArrowLeft style={{ marginRight: '8px' }} /> }) => {
  ...
  return (
    <NavLink
      ...
      style={{
        ...
        boxShadow: isHovered 
          ? (isDark ? '0 6px 16px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(255, 255, 255, 0.2) inset' 
                    : '0 6px 16px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(0, 0, 0, 0.1) inset')
          : (isDark ? '0 4px 12px rgba(0, 0, 0, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.1) inset' 
