...
const Navbar = () => {
      ...
      >
        <button
          ...
          style={{
            ...
            background: isDark ? 'rgba(20, 20, 30, 0.7)' : 'rgba(255, 255, 255, 0.8)',
            boxShadow: isHovered 
              ? (isDark ? '0 6px 20px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(255, 255, 255, 0.2) inset' 
                        : '0 6px 20px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(0, 0, 0, 0.1) inset')
              : (isDark ? '0 4px 16px rgba(0, 0, 0, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.1) inset' 
  ...
  const themeIcon = isSystemTheme ? 
    <div style={{ display: 'flex', alignItems: 'center' }}>
      {isDark ? <FaMoon size={iconSize} style={{ marginRight: '4px', color: colors.moon }} /> : <FaSun size={iconSize} style={{ marginRight: '4px', color: colors.sun }} />}
      <FaCog size={iconSize * 0.6} />
    </div> 
    : isDark ? <FaMoon size={iconSize} color={colors.moon} /> : <FaSun size={iconSize} color={colors.sun} />;
        ...
        <button
          ...
          style={{
            ...
            boxShadow: hoveredButton === 'reset' ? 
              (isDark ? '0 0 8px rgba(255, 255, 255, 0.2)' : '0 0 8px rgba(0, 0, 0, 0.15)') : 
              'none',
            backdropFilter: isDark ? 'blur(10px)' : 'none',
            WebkitBackdropFilter: isDark ? 'blur(10px)' : 'none',
            outline: 'none',
