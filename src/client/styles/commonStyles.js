const commonStyles = {
  ...
  calendar: {
    ...
    button: (theme, isHovered = false, isDisabled = false) => ({
      ...
      backgroundColor: isDisabled 
        ? theme === 'dark' ? 'rgba(20, 20, 20, 0.7)' : '#e0e0e0'
        : theme === 'dark' ? 'rgba(20, 20, 30, 0.7)' : '#fff',
    ...
    checkbox: {
      ...
      outer: (theme, isChecked, isHovered) => ({
        ...
        backgroundColor: isChecked 
          ? (theme === 'dark' ? '#2a4d69' : '#cce5ff') 
          : 'transparent',
        boxShadow: isHovered 
          ? (theme === 'dark' ? '0 0 8px rgba(255, 255, 255, 0.2)' : '0 0 8px rgba(0, 0, 0, 0.1)') 
          : 'none',
  ...
  appButtonContainer: (theme, isHovered) => ({
    ...
    margin: '0 auto',
    position: 'relative',
    backgroundColor: theme === 'dark' ? 'rgba(20, 20, 30, 0.7)' : 'rgba(255, 255, 255, 0.8)',
    backdropFilter: 'blur(10px)',
    WebkitBackdropFilter: 'blur(10px)',
    borderRadius: '16px',
    overflow: 'hidden',
  ...
  themeTransition: {
    ...
    getGlobalStyles: (theme) => {
      return commonStyles.themeTransition.cssVars + 
